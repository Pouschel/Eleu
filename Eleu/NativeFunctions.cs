...
public class NativeFunctions : NativeFunctionBase
{
  ...
  private static object len(object[] args)
  {
    CheckArgLen(args, 1);
    var arg0 = args[0];
    if (arg0 is string s) return new Number(s.Length);
    if (arg0 is EleuList l) return new Number(l.Len);
    throw new EleuNativeError("In der Funktion len muss das Argument ein String oder eine Liste sein.");
  }
