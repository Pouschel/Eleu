...
namespace Eleu.Debugger
{
	...
	public abstract class DebugSession : ProtocolServer
	{
		...
		public virtual void Initialize(Response response, dynamic args) { }

		public virtual void Launch(Response response, dynamic arguments) { }

		public virtual void Attach(Response response, dynamic arguments) { }

		public virtual void Disconnect(Response response, dynamic arguments) { }
		...
		public virtual void SetBreakpoints(Response response, dynamic arguments) { }

		public virtual void Continue(Response response, dynamic arguments) { }

		public virtual void Next(Response response, dynamic arguments) { }

		public virtual void StepIn(Response response, dynamic arguments) { }

		public virtual void StepOut(Response response, dynamic arguments) { }

		public virtual void Pause(Response response, dynamic arguments) { }

		public virtual void StackTrace(Response response, dynamic arguments) { }

		public virtual void Scopes(Response response, dynamic arguments) { }

		public virtual void Variables(Response response, dynamic arguments) { }

		public virtual void Source(Response response, dynamic arguments) { }

		public virtual void Threads(Response response, dynamic arguments) { }

		public virtual void Evaluate(Response response, dynamic arguments) { }
		...
		public void WriteToStdOut(string s)=> SendOutput("stdout", s);
		public void WriteToStdErr(string s)=> SendOutput("stderr", s);
		public void WriteToConsole(string s)=> SendOutput("console", s);
	}
